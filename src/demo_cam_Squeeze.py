...
class ObjectDetectionCornerNetLite:
    ...
    def run(self, arg, detector):
        ...
        if arg == "video":
            ...
            writer = self.record(width, height)
        elif arg == "camera":
            cap = self.camera_open()   
            ...
            imgs_path = self.load_color4train(data_path)
            save_flag = True
        ...
        while not rospy.is_shutdown():
            ...
            if arg == "video" or arg == "camera":              
                ...
                for img_path in imgs_path:
                    ...
                    image, bounding_boxes, _, _ = self.obj_inference(detector, img, self.count, image_name=img_name, flag=save_flag)
                    self.count += 1
                break
...
if __name__ == "__main__":
    ...
    instance.run(args[1], instance.detector)
